...
public class PortfolioTests
{
    ...
    public void Constructor_Should_Set_Initial_State()
    {
        ...
        Assert.Equal("Initial Deposit", portfolio.Transactions.First().Type);
    }
    ...
    public void DeductFunds_Should_Reduce_Balance_And_Add_Transaction()
    {
        ...
        Assert.Equal(2, portfolio.Transactions.Count);
    ...
    public void Multiple_Transactions_Should_Be_Tracked_In_Order()
    {
        ...
        Assert.Equal(4, portfolio.Transactions.Count);
        Assert.Equal(InitialBalance - 100m + 200m - 50m, portfolio.VirtualBalance);
        Assert.Equal(InitialBalance, portfolio.Transactions.ElementAt(1).BalanceBefore);
        Assert.Equal(InitialBalance - 100m, portfolio.Transactions.ElementAt(2).BalanceBefore);
        Assert.Equal(InitialBalance - 100m + 200m, portfolio.Transactions.ElementAt(3).BalanceBefore);
    }
}
